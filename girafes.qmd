...
title: "Statistiques sur jeu de données sur les girafes"
group: "Marine,	Alexia, Julie, Caroline, Bastien, Lily, Elia" 
...
girafe <- read.table("thermo_girafe.csv", sep = "," , header = TRUE)
```
