...
-   **2.Analysis of Potential Interactions Among the X Variables**
...
-   **3.Checking for Potential Collinearity Among the X Variables**
...
```{r colinéarity1, echo=TRUE, message=FALSE, warning=FALSE, paged.print=TRUE}
