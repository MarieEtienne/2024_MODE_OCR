...
```{r valeurs aberrantes de Y, echo=FALSE}
...
```{r distribution de Y, echo=FALSE}
...
Nous ne constatons pas de valeur aberrantes sur le Cleveland plot ou sur l'histogramme.

Nous remarquons grâce au Quantile plot un écart à la normalité. Ceci suggère qu'il est ici interressant d'utilisé un modèle linéaire généralisé et non un modèle linéaire classique.
