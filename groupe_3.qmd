...
opts_chunk$set(echo = FALSE, comment = "", cache = TRUE, fig.align = "center")#(TROUVER L'UTILITE ET PEUT-ÊTRE RETIRER -> permet de ne pas afficher le code mais seulement les graphiques : permet d'avoir un document plus propre -> à voir si on met partout du coup, où à quelques endroits)
