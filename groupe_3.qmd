...
Afin de vérifier qu'aucun individu possède une influence trop importante dans l'analyse, nous allons faire une représentation graphique du poids de chaque individus. Si le poids d'un individu dépasse 1, il est trop influent dans l'analyse. L'analyse ne serait donc pas valide et il faudrait la refaire en retirant cet individus.
...
Ici, il n'y a pas d'individus trop influents.
