...
We load 4 datasets which will later be cleaned, edited and fused : - data_chiro contains information collected during each capture event of the study : date, location in French Guiana, sex, age and reproductive state of the captured bats. - data_abiot_50_22 and data_abiot_23_24 describe meteorological data from French Guiana from 1950 to 2024. We retrieved it from [data.gouv](https://www.data.gouv.fr/fr/). - coord_chiro containing capture locations' coordinates (degree minute second), closest municipality and locality.
