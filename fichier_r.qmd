...
```{r}
# Importation du jeu de données coefla et tri des données
...
names(data_chiro)[1] <- "Annee"
colnames(data_chiro)

data_chiro = data_chiro %>%
  select("Annee", "Commune", "Localite", "Date", "Heure", "Espece", "Sexe", "Repro", "Age", "AB", "D5", "D3", "Masse", "MF", "DC", "Milieu") 
