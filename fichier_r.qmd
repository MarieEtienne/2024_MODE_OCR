...
### At this time, we plot the relation between our response variable and every covariable
...
ggplot(data_final, aes(Year, repro_positive)) +
  geom_point() + 
  geom_smooth(method = "loess") +
  scale_y_continuous(trans='log10')
```
...
But we might try to explain more explicitly as this :
