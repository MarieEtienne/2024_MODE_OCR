...
title: "Exploring data on penguins" group: "CHOULETTE Klervi, DENIS Manon, DUPORT Maureen, MOTTE Arthur, POYARD Antoine, SESIA Marion, TANGUY Céline" bibliography: references. bib execute: freeze: auto output: html_document: toc: true toc_float: true toc_depth: 3 number_sections: yes
...
=======
```{r}
>>>>>>> 0b00628cfb722b26812d2f8aa9439fbd7bf566dd
...
ggplot(data, aes(x = delta_15_N, y = delta_13_C, color = species))+
  ...
  facet_grid(~species)
```
There seem to be different trends between species. 
...
We begin the analysis by exploring the data and looking for aberrant values. First we look at the response variable: body mass
...
Finally we look at the qualitative explanatory variables.
