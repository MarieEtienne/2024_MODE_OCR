...
fviz_pca_biplot(acp_data, label="var", habillage=data$island, title = "Projection of variables and individuals and differentiation according to the islands", ylim=c(-3,3.5),xlim = c(-3.5,3.5))
