...
bibliography: references_penguins.bib 
execute:
  freeze: auto
  warning: false
output: 
...
## ANOVA, U-Mann-Whitney tests, Student test {style="color:royalblue"}
...
# Body mass model: an example of ANCOVA {style="color:navy"}
...
## Data exploration {style="color:royalblue"}
...
### Response variable exploration {style="color:royalblue"}
...
### Explanatory variables exploration {style="color:royalblue"}
