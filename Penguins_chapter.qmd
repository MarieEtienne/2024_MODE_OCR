...
va_propre
```
Determind the absolut contribution of variables to each axis.  
...
First graph show the result of PCA on axes 1 and 2. *A priori* clustering by the Species has been performed.  
...
Second graph show the result of PCA on axes 1 and 2. *A priori* clustering by the Island has been performed.  
