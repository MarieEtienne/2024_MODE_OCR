...
We will performing an ANOVA to see the effect of qualitatives variables (state, habitat, species, year) on the quantitatives (nest_fate, initiation_date, number_fledged, nest_end_date) variables in the Bird_dataset.csv dataset.


  A. Effect on Nest_fate
  
  
  
  B. Effect on Initiation_date
  
  
  
  C. Effect on Number_fledged



  D. Effect on Nest_end_date
