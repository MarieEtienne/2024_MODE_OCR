...
Example of an existing dataframe 
Thoose data were colected on the Will county in 1995
...
Creation of a summary dataframe for each dataframe
...
bird_anim <- tm_shape(us_states) + 
  ...
  tm_view(bbox = c(-92.6, 36.9, -87.5, 49.0))

# Show the animated map
tmap_animation(bird_anim)
```
Please, check out the newly created map on the "Viewer" panel of your Rstudio 