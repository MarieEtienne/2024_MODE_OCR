...
clusters to make. It uses the k-means method.
...
We can define classes for a CAH thanks to the function fviz_cluster.
...
It is necessary to note that several species are located on the counties
near the border between the Illinois and the Wisconsin. Thus they can be
seen in both states, which can be counter-intuitive by seeing the FAMD.
However, one factor that can explain this distribution could be years of
