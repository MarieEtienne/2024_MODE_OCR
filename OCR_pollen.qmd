...
```
La richesse specifique des zones paturees semble etre
plus importante que dans les zones non paturees. 
...
anova(hyp0,hyp1)
```
La p-value est inferieure a 0,05 donc
le paturage a un effet significatif sur la richesse
specifique. 
