...
The p-value of the shapiro test is still less than 0.05, so the residuals are still not normally distributed. We will therefore apply a generalised model (poisson, binomiale n�gative. 
