...
shapiro.test(res)
```
The residuals are not normally distributed. We're going to try and do some transformations using log and sqrt. In fact, they appear to have a negative binomial distribution.
```{r TransfoLog}
